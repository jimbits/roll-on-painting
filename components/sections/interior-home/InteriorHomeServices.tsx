...
interface InteriorHomeServicesProps {
  children?: ReactNode;
  className?: string;
}
...
function InteriorHomeServices({ className }: InteriorHomeServicesProps) {
  return (
    <section className={cn('mx-auto max-w-7xl p-4', className)}>
      <header className="mx-auto mb-8 max-w-xl lg:mx-0 lg:mb-12 lg:max-w-full">
        <h2 className="text-3xl font-extrabold text-pretty text-zinc-800 sm:mb-2 sm:text-4xl lg:mb-2 lg:text-center lg:text-6xl">
          Interior Home Painting Services
        </h2>
        <p className="mx-auto text-base/snug font-medium text-gray-600 sm:text-center lg:w-[70%] lg:text-center lg:text-xl/snug lg:text-pretty">
      ...
      <section className="mx-auto max-w-xl space-y-8 lg:grid lg:max-w-full lg:grid-cols-2 lg:grid-rows-[repeat(2,250px)] lg:gap-x-12">
        <header className="lg:col-start-2 lg:col-end-3">
          <h2 className="text-xl font-bold sm:text-2xl lg:text-2xl">Core Interior Services</h2>
...
export default InteriorHomeServices;
